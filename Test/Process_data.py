...
with open('Kingston_Police_Formatted.csv','a') as out:
    for x in range(len(incident_type)):
        out.write(str(incident_type[x][0])+","+str(incident_type[x][1])+","+str(incident_type[x][2])+","+str(incident_type[x][3])+","+str(incident_type[x][4])+","+str(incident_type[x][5])+","+str(incident_date_time[x])+","+str(incident_lat[x])+","+str(incident_long[x])+","+str(normalized_lat[x])+","+str(normalized_long[x])+"\n")
